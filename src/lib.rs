...
#[derive(Debug)]
pub struct TechRealmProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TechRealmProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TechRealm processing");
    
    let mut processor = TechRealmProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TechRealmProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TechRealmProcessor::new(false);
